export const profile = {
	...
	author_name: 'Jeanne Marlier', // Author name to be highlighted in the papers section
	research_areas: [
...
export const template = {
	website_url: 'https://jeannezmarlier.github.io', // Astro needs to know your site’s deployed URL to generate a sitemap. It must start with http:// or https://
	menu_left: false,
	transitions: true,
